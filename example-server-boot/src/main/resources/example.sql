...
CREATE TABLE `example` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_example_num` (`num`) USING HASH COMMENT '编码唯一性索引',
  KEY `index_example_create_date` (`create_date`) USING BTREE COMMENT '创建时间查询索引',
  KEY `index_example_update_date` (`update_date`) USING BTREE COMMENT '更新时间查询索引'
